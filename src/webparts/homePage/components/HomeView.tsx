    ...
    return (
        <section >
            <Stack enableScopedSelectors styles={stackStyles}>
                <DefaultButton text='Create New Request' className={userRoleobj.CreateFlowV ? styles.homePageButton:styles.homePageButtonDisabled } disabled={!userRoleobj.CreateFlowV} href='sitepages/request.aspx' />
                <DefaultButton text='Request List' className={userRoleobj.RequestFlowV ? styles.homePageButton:styles.homePageButtonDisabled } disabled={!userRoleobj.RequestFlowV} href='Lists/Request%20List'/>
                ...
                <DefaultButton text='Inventory Management' className={userRoleobj.InventoryV ? styles.homePageButton:styles.homePageButtonDisabled } disabled={!userRoleobj.InventoryV} href='Lists/Inventory%20Management' />
            </Stack>
