...
export default class CalculatorV2WebPart extends BaseClientSideWebPart<ICalculatorV2WebPartProps> {

  private _isDarkTheme: boolean = false;
  private _environmentMessage: string = '';

  public render(): void {
    const element: React.ReactElement<ICalculatorV2Props> = React.createElement(
      CalculatorV2,
      {
