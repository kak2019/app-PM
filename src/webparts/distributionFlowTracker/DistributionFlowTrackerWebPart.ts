...
export default class DistributionFlowTrackerWebPart extends BaseClientSideWebPart<IDistributionFlowTrackerWebPartProps> {

  private _isDarkTheme: boolean = false;
  private _environmentMessage: string = '';

  public render(): void {
    const element: React.ReactElement<IDistributionFlowTrackerProps> = React.createElement(
      DistributionFlowTracker,
      {
